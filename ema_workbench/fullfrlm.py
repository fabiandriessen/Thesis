...
def flow_refueling_location_model(load, r, stations_to_place, station_cap, max_per_loc, additional_nodes=0,
    ...
    optimal_facilities, optimal_flows, non_zero_flows, supported_flow, routes_supported, extra_nodes_used = second_stage_frlm(stations_to_place,
    ...
    return total_flow, fraction_captured_total, serveable_fraction, served_fraction, routes_supported, extra_nodes_used
